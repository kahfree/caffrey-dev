...
const LINE_COLOR = "rgba(16, 185, 129, 0.09)"; // emerald, faint — background texture, not a diagram
...
export default function RedesignBackground() {
  ...
  return (
    <div className="fixed inset-0 -z-10 bg-black overflow-hidden" style={{ perspective: "700px" }}>
      <canvas
        ref={canvasRef}
